...
- Vercel에 정적 사이트로 직접 배포. **깃허브 연동 완료** — `git push`하면 별도 `vercel --prod` 없이도 향후 레포·배포 흐름을 그대로 이어갈 수 있음(원격: `xmfrhd-create/junjae`, 2026-09-12에 `jasoseo-test`에서 개명. Vercel 프로젝트명도 `junjae`로 이미 통일됨).
